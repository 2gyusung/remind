...
export default function StaticRoutingPage(){
    ...
    const onClickSubmit1 = () => {
        ...
        // 2. 등록된 페이지로 이동하기
        router.push("/section07/07-04-dynamic-routing-board-query-moved/24254")
    }

    const onClickSubmit2 = () => {
        router.push("/section07/07-04-dynamic-routing-board-query-moved/2")
    }

    const onClickSubmit3 = () => {
        router.push("/section07/07-04-dynamic-routing-board-query-moved/3")
    }
